/**
* A customized version of the `Matter.Render` module.
*
* @class CustomRender
*/
...
(function() {
    ...
    CustomRender.create = function(options) {
        ...
        // Customize display of text onto canvas.
        render.context.font = "20px Arial";
        render.context.textAlign = "center";
        render.context.fillStyle = "cyan";
    ...
    CustomRender.world = function(render, simState, valueGrid) {
        ...
        if (valueGrid)
            CustomRender.valueGrid(render, context, valueGrid);
...
//                c.fillStyle = 'rgba(0,0,0,0.5)';
    ...
    /**
     * AV - Displays a grid of values as a grayscale image.
     */
    CustomRender.valueGrid = function(render, context, grid) {
        var c = context,
            options = render.options;
        ...
        */
        ...
        var cellHeight = c.canvas.height / gridHeight;
